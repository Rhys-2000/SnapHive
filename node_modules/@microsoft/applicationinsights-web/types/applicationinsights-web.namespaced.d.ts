...
declare namespace ApplicationInsights {
    ...
    class ApplicationAnalytics extends BaseTelemetryPlugin implements IAppInsights, IAppInsightsInternal {
        ...
        identifier: string;
        priority: number;
        readonly config: IConfig & IConfiguration;
        queue: Array<() => void>;
    ...
    type OnCompleteCallback_2 = (status: number, headers: {
     ...
     */
    type SendPOSTFunction = (payload: IPayloadData, oncomplete: OnCompleteCallback_2, sync?: boolean) => void | IPromise<boolean>;
